...
INSERT INTO `prestation` VALUES (1,NULL,1,1,1,NULL,'2020-10-01 00:00:00','2020-10-02 00:00:00',NULL,NULL,'2020-10-10 00:00:00',NULL,846.51,'2020-10-15 00:00:00','2020-10-30 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL),(2,NULL,1,1,1,NULL,NULL,'2020-10-10 00:00:00',NULL,NULL,NULL,NULL,846.51,'2020-10-17 00:00:00','2020-11-01 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL),(3,NULL,2,3,2,NULL,NULL,'2021-02-10 00:00:00',NULL,NULL,NULL,NULL,956.1,'2021-02-15 00:00:00','2021-02-20 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL),(4,NULL,1,4,1,NULL,NULL,'2021-03-10 00:00:00',NULL,NULL,NULL,NULL,632.25,'2021-03-15 00:00:00','2021-03-30 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL),(5,NULL,2,4,2,NULL,NULL,'2021-04-10 00:00:00',NULL,NULL,NULL,NULL,756.47,'2021-04-15 00:00:00','2021-04-30 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL),(6,NULL,1,5,1,NULL,NULL,'2021-05-10 00:00:00',NULL,NULL,NULL,NULL,812.36,'2021-05-15 00:00:00','2021-05-30 00:00:00',1,10,NULL,NULL,NULL,NULL,NULL);
...
/*!50001 CREATE VIEW `test` AS SELECT 
 ...
 1 AS `date_debut`,
 1 AS `date_fin`,
 1 AS `description_offre`,
 1 AS `type_installation`,
 1 AS `prix_km`,
 1 AS `coef_installation`,
 1 AS `coef_intervention`,
 1 AS `prix_bete_jour`,
 1 AS `zone_couverture`,
 1 AS `adresse_offre`,
 1 AS `date_annulation_offre`,
 1 AS `ville_troupeau`,
 1 AS `ville_terrain`,
 1 AS `distance`*/;
...
/*!50001 VIEW `test` AS select `o`.`id_offre` AS `id_offre`,`o`.`id_frequence` AS `id_frequence`,`o`.`id_troupeau` AS `id_troupeau`,`o`.`id_type` AS `id_type`,`o`.`id_condition` AS `id_condition`,`o`.`nom_offre` AS `nom_offre`,`o`.`date_ajout` AS `date_ajout`,`o`.`date_debut` AS `date_debut`,`o`.`date_fin` AS `date_fin`,`o`.`description_offre` AS `description_offre`,`o`.`type_installation` AS `type_installation`,`o`.`prix_km` AS `prix_km`,`o`.`coef_installation` AS `coef_installation`,`o`.`coef_intervention` AS `coef_intervention`,`o`.`prix_bete_jour` AS `prix_bete_jour`,`o`.`zone_couverture` AS `zone_couverture`,`o`.`adresse_offre` AS `adresse_offre`,`o`.`date_annulation_offre` AS `date_annulation_offre`,`tr`.`id_ville` AS `ville_troupeau`,(select `t`.`id_ville` from `terrain` `t` where (`t`.`id_terrain` = 1)) AS `ville_terrain`,(select `d`.`distance` from `distance_villes` `d` where (((`d`.`id_ville` = `ville_troupeau`) and (`d`.`vil_id_ville` = `ville_terrain`)) or ((`d`.`id_ville` = `ville_terrain`) and (`d`.`vil_id_ville` = `ville_troupeau`)))) AS `distance` from (`offre` `o` left join `troupeau` `tr` on((`o`.`id_troupeau` = `tr`.`id_troupeau`))) */;
...
-- Dump completed on 2021-06-16 19:36:38
